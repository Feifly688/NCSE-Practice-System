  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: Math.max(460, cardHeight + 100) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
      >
        <div
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 text-white text-lg font-semibold">
            {item.title}
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        <div className="truncate text-xl font-bold text-white">{item.title}</div>
        {item.description && (
          <div className="mt-2 line-clamp-2 text-sm text-white/80">{item.description}</div>
        )}
      </div>
    </div>
  );
